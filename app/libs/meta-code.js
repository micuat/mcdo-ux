...
{desc:"",code:"src(o0).modulate(gradient().brightness(-.5).pixelate(2,2),-.1).layer(src(s0).mask(shape(4,0.5,0))).out()"},
{desc:"",code:"src(o0).modulate(gradient().brightness(-.5).pixelate(2,2),-.1).layer(src(s0).mask(shape(4,0.5,0))).modulate(noise(),0.01).out()"},
{desc:"",code:"src(o0).modulate(gradient().brightness(-.5).pixelate(2,2),-.1).hue(0.1).layer(src(s0).mask(shape(4,0.5,0))).out()"},
{desc:"",code:"src(o0).modulate(gradient().brightness(-.5).pixelate(2,2),-.1).hue(0.1).layer(src(s0).mask(osc(50,0).thresh(.8,0))).out()"},
{desc:"",code:"src(o0).modulate(gradient().brightness(-.5).pixelate(2,2),-.1).layer(src(s0).mask(osc(50,0).thresh(.8,0))).out()"},
{desc:"",code:"src(o0).modulate(gradient().brightness(-.5).pixelate(2,2),-.1).layer(src(s0).mask(osc(50,0).rotate(.79).thresh(.8,0))).out()"},
  ],
};
